  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="prose prose-invert text-brand-grey leading-relaxed space-y-6">
        <h2 className="text-lg font-bold text-brand-white uppercase tracking-wider pt-4">Company Details</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-brand-white uppercase tracking-wider pt-4">Commercial Registry</h2>
        <p>
          Registered name: HERR Design Collective GmbH<br />
          UID / Corporate Identification: CHE-346.401.551
        </p>

        <h2 className="text-lg font-bold text-brand-white uppercase tracking-wider pt-4">Authorised Representative</h2>
        <p>
