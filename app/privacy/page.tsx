  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-24">
      ...
      <div className="prose prose-invert text-brand-grey leading-relaxed space-y-6">
        ...
        <h2 className="text-lg font-bold text-brand-white tracking-wider pt-6">1. Information we collect</h2>
        <p>
        ...
        <h2 className="text-lg font-bold text-brand-white tracking-wider pt-6">2. Data security &amp; sharing</h2>
        <p>
