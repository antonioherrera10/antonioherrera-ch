...
const CONTENT = {
  EN: {
    ...
    pdfCta: "Download PDF",
    unlockTitle: "Unlock your path! Enjoy life to the fullest.",
    footerShop: "Boutique",
    footerAbout: "About",
  ...
  DE: {
    ...
    unlockTitle: "Entfessle deinen Weg! Genieße das Leben in vollen Zügen.",
    footerShop: "Boutique",
  ...
  ES: {
    ...
    unlockTitle: "¡Desbloquea tu camino! Disfruta la vida al máximo.",
    footerShop: "Boutique",
